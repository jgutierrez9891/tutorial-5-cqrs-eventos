...
consumer = client.subscribe('eventos-contrato', consumer_type=_pulsar.ConsumerType.Shared, subscription_name='sub-notificacion-eventos-contratos', schema=AvroSchema(EventoContratoCreado))
